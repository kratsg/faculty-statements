...
\section{Summary}
Between emerging technologies, multiple proposed international collider experiments, and the ongoing Snowmass effort - the next decade of particle physics is going to be incredibly interesting. I hope you can understand my research program's broad scope at the energy frontier covering the three major pieces of experimental high energy physics: physics, software, and hardware. The next five years of my research program will focus on the third run of the LHC, starting at the beginning of 2022. A critical piece of this research program is the successful operation of the improved trigger system to allow for the efficient triggering of events with MET and Lorentz-boosted objects. \textbf{to do}
