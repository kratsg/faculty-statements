...
\recipient{University of Arizona, Department of Physics}{Physics-Atmospheric Sciences (PAS)\\Room 232, Second Floor\\1118 E. Fourth Street\\Tucson, AZ 85721}
\date{August 8th, 2023}
\opening{Dear Professor Erich Varnes and Search Committee,}
\closing{Sincerely,}
...
Over the next decade, I plan to continue my close collaborations with various institutions and labs, including UChicago, UCSC, UCI, UNM, and IRIS-HEP, to support my research program of searching for new physics Beyond the Standard Model. In particular, I plan to search for light supersymmetric particles, dark matter candidates compatible with astrophysical and cosmological measurements. At UA, I am excited to work closely with the physics faculty and know all of you as scientists and humans. I would also feel remiss if I did not mention a little bit of excitement about enjoying one of the UNESCO Cities of Gastronomy (Sonoran-style Mexican food). Finally, you will notice that I included a picture and my pronouns on all material (except this letter). As a Deaf physicist, I am a very visual learner, and this should help you associate my story to my face. I am happy to provide any additional material upon request.
