...
\closing{Sincerely,}
\enclosure[Enclosed]{curriculum vit\ae{}, Statement of Teaching, Statement of Research, Statement of Diversity, list of publications, five Letters of Reference}          % use an optional argument to use a string other than "Enclosure", or redefine \enclname
