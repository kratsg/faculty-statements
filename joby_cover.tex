...
\recipient{Joby Aviation, Inc.}{333 Encinal Street\\Santa Cruz, CA 95060}
...
Hi Joby Aviation, my name is Giordon Stark, and I am what you might call a "licensed quantum mechanic." Over the past decade, I have spent my time in academia trying to balance the trifecta of work that rattles my brain: physics, software, and hardware. As you have probably guessed by this cover letter and the following resume, I am considering a transition from academia into the tech industry, and you caught my eye. I would best fit a superposition of a data scientist and software engineer role. I have particular strengths in the listed requirements on the application: containerization, python, and continuous integration/deployment.
